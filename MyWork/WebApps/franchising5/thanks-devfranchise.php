<?php
 ...
 Template Name: Шаблон - Спасибо страница Разработки франшиз
...
<head>
    <meta name="robots" content="noindex, nofollow" />
    	...
    	<div class="content">
    		<!-- Blog -->
    		<div id="thanks-devfranchise" class="thanks">
    			<div class="page-wrapper">
    				<div class="inner">
	    				...
	    				<div class="manager">
	    					<div class="m-inner">
		    					<img src="<?php bloginfo('template_url'); ?>/assets/img/thanks/thanks-devfranchise.png">
		    					<p class="devfra"><span>Сергей Кутьин</span> Руководитель отдела упаковки франшиз</p>
	    					</div>
	    				</div>
